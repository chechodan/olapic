...
class MediaTest extends WebTestCase 
{
  ...
  protected static $_instagram_access_token;
  protected static $_facebook_access_token;
  ...
  public static function setUpBeforeClass() 
  {
    ...
    self::$_instagram_access_token = InstagramSocialMedia::PARAM_ACCESS_TOKEN;
    self::$_facebook_access_token = FacebookSocialMedia::PARAM_ACCESS_TOKEN;
    self::$_app = require __DIR__.'/../../../app.php';
  }
  ...
  public function createApplication()
  {
    ...
    $instagram_access_token = trim($app[self::$_instagram_access_token]);
    $facebook_access_token = trim($app[self::$_facebook_access_token]);
  ...
  protected function getResponse($media_id, $access_token){
    ...
    $client->request('GET', '/media/'.$media_id.'?access_token='.$access_token);
